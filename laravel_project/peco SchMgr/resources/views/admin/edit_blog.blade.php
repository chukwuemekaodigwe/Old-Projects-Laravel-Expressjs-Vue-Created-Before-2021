...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Update Blog Post</h1>
    ...
    <div class="col-md-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary"> {{ ucwords($blog->title) }} Blog Post</h6>
                <div style="float: right; margin-righht: 10px;"><button type="button" class="btn btn-link btn-sm"
                        onclick="return window.location='/dash/blogs/all';"> <i class="fas fa-cloud"></i>
                        Published Posts</button></div>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                <form class="form-material" method="post" action="/dash/blogs/{{ $blog->url }}
               " enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="{{ 'title' }}" type="text"
                                    ...
                                    value="{{ $blog->title }}" required autocomplete="{{ 'title' }}"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="categ" id="categ"
                                    ...
                                    <option value="{{ $category->id }}" acceskey="{{ substr(($category->name), 0, 1) }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="summary" style="min-height:100px!important" maxlength="120"
                                ...
                                title="Give a detailed summary of the post. Highlighting the main contents of the post. IN 70 WORDS "> {!! $blog->summary !!}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="tags" style="min-height:50px!important"
                                ...
                                autocomplete="{{ 'tags' }}"
                                title="Keywords either used/relating to this post"> {{ str_replace('|', ',', $blog->tags) }} </textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="{{ 'image' }}" title="An image to show as a highlight image"
                                class="col-md-5 col-form-label text-md-left">{{ __(ucwords(str_replace('_', ' ', ('Header Image')))) }}</label>

                            <div class="col-md-12">
                            <span> <img src="{{asset('/img/header/'.str_replace(' ', '-', $blog->title).'.jpeg')}}" height="100px" width="100px" class="img-responsive" /></span>
                                <input id="{{ 'image' }}" type="file"
                                    title="An image to show as a highlight image not more than 30KB" @error('image')
                                    is-invalid @enderror" name="{{ 'image' }}" required
                                    accept="image/jpeg">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="{{ 'writer_name' }}" type="{{ isset($type) ? $type : 'text' }}"
                                    ...
                                    name="{{ 'writer_name' }}" value="{{ $blog->writer_name }}" required
