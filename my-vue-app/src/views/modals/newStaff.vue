<template>
    <ion-modal ref="modal" trigger="new-staff-modal" :is-open="false" :can-dismiss="canDismiss"
        ...
        <ion-content class="ion-padding">
            <form>
                ...
                <ion-item>
                    <ion-label position="stacked">Staff Type</ion-label>
                ...
                <ion-row>
                    ...
                    <ion-col size="6">
                        <ion-item>
                            <ion-label position="stacked">Staff Picture</ion-label>
