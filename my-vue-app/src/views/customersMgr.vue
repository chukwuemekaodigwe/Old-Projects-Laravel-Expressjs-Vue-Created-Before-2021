<template>
    <ion-page>
      ...
      <ion-content fullscreen>
        <div id="containe">
          <ion-searchbar slot="start" placeholder="search by customers by name, phone.."></ion-searchbar>
          <ion-list>
            <ion-item lines="full" v-for="product in products" :key="product.id">
              ...
              <ion-label class="ion-text-wrap" @click="viewProduct()">
                ...
                <ion-row>
                  ...
                  <ion-col class="product-separator">
                    <ion-text color="secondary">
                      <p><strong>Email: {{product.cost_price}}</strong></p>
                    </ion-text>
                  </ion-col>
        ...
        <ion-fab vertical="bottom" horizontal="center" slot="fixed">
          <ion-fab-button id="new-customer-modal">
...
import { add, addCircle, createOutline, trashOutline } from "ionicons/icons";
  ...
  import newCustomer from "@/views/modals/new_customer_modal.vue";
