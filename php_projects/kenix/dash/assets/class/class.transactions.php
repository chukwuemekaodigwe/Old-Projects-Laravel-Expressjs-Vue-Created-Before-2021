...
class Repayment
{
    ...
    public static function getPendingRepayments()
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('SELECT * FROM repayment WHERE status != 1');
    ...
    public static function getRepaymentByTransId($trans_id)
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('SELECT * FROM repayment WHERE id = :id');
        $get->bindValue(':id', $trans_id, PDO::PARAM_INT);
        $get->execute();
    ...
    public static function addRepayment($trans, $type)
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('INSERT INTO repayment(reg_date, trans_id, type, status) VALUES(NOW(), :trans, :type, :status)');
    ...
    public static function updRepayment($trans_id)
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('UPDATE repayment SET count = count + 2 WHERE trans_id = :trans');
    ...
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('UPDATE repayment SET status = :status WHERE trans_id = :trans');
        $get->bindValue(':trans', $trans_id, PDO::PARAM_INT);
    ...
    public static function getNxtActiveRepayment($plan)
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('SELECT b.* FROM repayment a, transaction b WHERE a.status = :status AND b.plan_id = :plan AND a.trans_id = b.id AND count < 2 ORDER BY id ASC LIMIT 1');
    ...
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('SELECT trans_id FROM `repayment` WHERE type = 1 AND status = 0 ORDER by id DESC LIMIT 1');
    ...
    public static function getRepaymentByTrans($trans_id)
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('SELECT * FROM repayment WHERE trans_id = :trans ');
...
// this is the repayment for clients,
class Redirect
{

    public static function addRedirect($receiver, $total, $plan)
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
        $get = $db->prepare('INSERT INTO redirect(receiver_id, plan_id, total, reg_date) VALUES(:receive, :plan, :total, NOW())');
    ...
    public static function incrementRedirect($id)
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
    ...
    public static function getNxtRedirect($plan)
    {
        $db = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD, $_SESSION['dbErr']);
