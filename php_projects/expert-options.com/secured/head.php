        ...
        <header class="page-header">
            <div class="page-header__bar">
                ...
                <div class="container flex-wr">
                    ...
                    <div class="flex-wr__col">
                        <a href="?p=support&item=exchange" style="padding: 1px; " class="rate-btn"><img
                                src="../assets/img/ic-hiw-3.png" height="25px" width="30px"
                                style="margin-bottom: -5px; margin-right: -10px;"> Exchange</a>
                    </div>
                    <div class="flex-wr__col">
            ...
            <div class="container page-header__main">
                <a href=../?p=home class="page-header__logo">
                    <img src="../assets/img/benefit.gif" alt="CryptoBoom">
                </a>
                ...
                <nav class="page-header__nav page-nav">
                    <ul>
                        ...
                        <li class="page-nav__item page-nav__item--sign"><a href="?pg=dash" class="btn btn--highlight"><i
                                    class="ic-sign ic-sign--up"></i> Dashboard</a></li>
                        <li class="page-nav__item page-nav__item--sign"><a href="?pg=exit"><i
                                    class="ic-sign ic-sign--in"></i>Logout&nbsp;&nbsp;</a></li>
                    </ul>
                </nav>
    ...
    if($_SESSION['user_type'] == 1){
		...
		?>
                <ul class="acc-nav__container">
                    ...
                    <li class="acc-nav__item wt-dropdown"><a href="#">Advanced</a>
                        <ul>
                            <li class="acc-nav__item"><a href="?pg=plans">Platforms</a></li>
                            <li class="acc-nav__item"><a href="?pg=btc_portal">BTC Address</a></li>
		...
		?>
                <ul class="acc-nav__container">
                    <li class="acc-nav__item acc-nav__item--active"><a href="?pg=dash">Overview</a></li>
                    <li class="acc-nav__item"><a href="?pg=credit">Invest</a></li>
