                        ...
                        <table class="table border mb-0">
                            ...
                            <tbody>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div>Ifeoma John</div>
                                        <div class="small text-medium-emphasis"> Borrowed: Jan 1, 2022</div>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td>
                                    <div class="fw-semibold">080685656565</div>
                                        <div class="small text-medium-emphasis"> mailer@gmail.com</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="#">Info</a><a class="dropdown-item" href="#">Print Schedules</a><a class="dropdown-item text-danger" href="#">Add Payment</a></div>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <div class="float-end"><small class="text-medium-emphasis">Jun 11, 2020 - Jul 10, 2022</small></div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small text-medium-emphasis">Last login</div>
                                        <div class="fw-semibold">15 minutes ago</div>
                                    </td>
                                    <td>
                                        <div class="small text-medium-emphasis">Last login</div>
                                        <div class="fw-semibold">15 minutes ago</div>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div>Quintin Ed</div>
                                        <div class="small text-medium-emphasis"><span>New</span> | Borrowed: Aug 18, 2022</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                    ...
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <div class="float-end"><small class="text-medium-emphasis">Jun 11, 2022 - Jul 10, 2022</small></div>
                                        </div>
                                        <div class="progress progress-thin">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-medium-emphasis"><span>New</span> | Borrowed: May 15, 2021</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                    ...
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <div class="float-end"><small class="text-medium-emphasis">May 11, 2020 - Jul 22, 2023</small></div>
                                        </div>
                                        <div class="progress progress-thin">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-medium-emphasis"><span>New</span> | Borrowed: Jan 1, 2020</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-medium-emphasis"><span>New</span> | Borrowed: Dec 21, 2021</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
