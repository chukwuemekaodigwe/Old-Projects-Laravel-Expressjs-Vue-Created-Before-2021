            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header">
                        <strong>New Employees</strong><span class="small ms-1">Fill in all the field</span>
                    </div>
                    <div class="card-body">
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label" for="validationCustom06"> Employee Branch</label>
                                <select class="form-select" id="validationCustom06" required="">
                                    <option selected="" disabled="" value="">Choose...</option>
                                    <option>Onitsha</option>
                                    <option>Ikeja</option>
                            ...
                            <div class="col-md-4">
                                <label class="form-label" for="validationCustom06">User Level</label>
                                <select class="form-select" id="validationCustom06" required="">
                                    <option selected="" disabled="" value="">Choose...</option>
                                    <option>CEO</option>
