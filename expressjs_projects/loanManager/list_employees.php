                        ...
                        <table class="table border mb-0">
                            ...
                            <tbody>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div>Ifeoma John</div>
                                        <div class="small text-medium-emphasis"><span>New</span> | Registered: Jan 1, 2022</div>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <div class="float-end"><small class="text-medium-emphasis">Jun 11, 2021 - Jul 10, 2022</small></div>
                                        </div>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-medium-emphasis"><span>Recurring</span> | Registered: Jan 1, 2022</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div>Quintin Ed</div>
                                        <div class="small text-medium-emphasis"><span>New</span> | Registered: Aug 18, 2022</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-medium-emphasis"><span>New</span> | Registered: May 15, 2021</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-medium-emphasis"><span>New</span> | Registered: Dec 21, 2021</div>
                                    </td>
                                    <td class="text-center">
                                        <svg class="icon icon-xl">
